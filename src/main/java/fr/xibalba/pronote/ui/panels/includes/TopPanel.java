...
public class TopPanel extends Panel {
    ...
    private void initAxiumMenu() {
        ...
        //params.setOnAction(event -> Core.getPanelManager().showPopup(new PopupSettings()));
    ...
    private void initHelpMenu() {
        ...
        l_default.setOnAction(event -> {
            ...
            Core.getPanelManager().updateTopBar();
            Core.getPanelManager().update();
        });
    ...
    private void initButtons() {
        ...
        fullScreen.setOnMouseClicked(e -> Core.getPanelManager().getStage().setMaximized(!Core.getPanelManager().getStage().isMaximized()));
        ...
        hide.setOnMouseClicked(e -> Core.getPanelManager().getStage().setIconified(true));
